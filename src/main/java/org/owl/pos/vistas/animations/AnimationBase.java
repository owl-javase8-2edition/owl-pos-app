...
package org.owl.pos.vistas.animations;
...
public class AnimationBase extends Transition {
     ...
     */
    public AnimationBase(final Node node, final Timeline timeline) {
     ...
     */
    public AnimationBase(final Node node, final Timeline timeline, final boolean useCache) {
        this.node = node;
